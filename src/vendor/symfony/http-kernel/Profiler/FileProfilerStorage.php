...
class FileProfilerStorage implements ProfilerStorageInterface
{
     ...
     *
     * Example : "file:/path/to/the/uploads/folder"
     *
    ...
    public function __construct(string $dsn)
    {
        if (!str_starts_with($dsn, 'file:')) {
            throw new \RuntimeException(\sprintf('Please check your configuration. You are trying to use FileStorage with an invalid dsn "%s". The expected format is "file:/path/to/the/uploads/folder".', $dsn));
        }
