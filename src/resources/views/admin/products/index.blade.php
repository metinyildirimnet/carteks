            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('admin.products.trashed') }}" class="btn btn-warning btn-sm mr-2">
                            <i class="fas fa-trash-alt"></i> Silinmiş Ürünler
                        </a>
                        <a href="{{ route('admin.products.create') }}" class="btn btn-success btn-sm">Yeni Ürün Ekle</a>
                    </div>
                </div>
                <!-- /.card-header -->
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                            @forelse ($products as $product)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('admin.products.destroy', $product->slug) }}" method="POST" style="display:inline-block;" onsubmit="return confirm('Bu ürünü silmek istediğinizden emin misiniz?');">
                                            @csrf
                                            @method('DELETE')
                            ...
                            @empty
                                <tr>
                                    <td colspan="8" class="text-center">Henüz ürün bulunmuyor.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
