...
@section('title', 'Yeni Kayan Yazı Öğesi Ekle')
    ...
    <div class="col-md-12">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Yeni Kayan Yazı Öğesi Ekle</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="is_active" id="is_active" class="form-control">
                            <option value="1" {{ old('is_active', 1) == 1 ? 'selected' : '' }}>Evet</option>
                            <option value="0" {{ old('is_active', 1) == 0 ? 'selected' : '' }}>Hayır</option>
                        </select>
                    </div>

                    <div class="form-group">
                        <label for="sort_order">Sıralama (İsteğe bağlı)</label>
                        <input type="number" id="sort_order" name="sort_order" class="form-control" value="{{ old('sort_order') }}">
                    </div>
                </div>
                <!-- /.card-body -->
